...
# No access control for file access through the 'p' parameter. # ⚠️ File Access Vulnerability — The parameter 'p' can be manipulated to access files outside of intended scope.
