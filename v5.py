...
def get_user_by_name_vuln(name):
    ...
    return cursor.fetchall() # ⚠️ Command Injection — User input 'username' is directly concatenated into the command. # ⚠️ Command Injection — Potential for command injection attack.
