...
import pickle
# ⚠ Hardcoded Secret — API_KEY should not be hardcoded; consider using environment variables.
...
# ⚠ Insecure File Upload — No checks on file type or content before saving.
