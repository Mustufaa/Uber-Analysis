...
app = Flask(__name__)
 # ⚠️ Insecure File Upload — No validation of file type or filename is performed. # ⚠️ Insecure File Upload — The uploaded file is not validated for type or filename.
